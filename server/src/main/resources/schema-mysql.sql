...
create table if not exists teaching_class (
  id bigint not null auto_increment primary key, course_id bigint not null, administrative_class_id bigint, name varchar(120) not null, term varchar(80) not null, enabled boolean not null default true,
  constraint fk_mysql_teaching_class_course foreign key (course_id) references course(id) on delete cascade,
  constraint fk_mysql_teaching_class_administrative foreign key (administrative_class_id) references administrative_class(id) on delete cascade
);
update teaching_class tc
set administrative_class_id=(select min(ac.id) from administrative_class ac where ac.name=tc.name)
where tc.administrative_class_id is null
  and (select count(*) from administrative_class ac where ac.name=tc.name)=1;
...
create table if not exists audit_log (
  id bigint not null auto_increment primary key, actor_id bigint, action varchar(80) not null, target_type varchar(80), target_id varchar(80), detail varchar(500), created_at datetime not null,
...
create table if not exists learning_task (
  id bigint not null auto_increment primary key, course_id bigint not null, task_type varchar(20) not null, name varchar(180) not null, description text, start_at datetime not null, deadline datetime not null, max_score int not null default 100, questions_json text, created_at datetime not null,
...
create table if not exists task_submission (
  id bigint not null auto_increment primary key, task_id bigint not null, student_name varchar(80) not null, student_no varchar(40) not null, submitted boolean not null default false, submitted_at datetime null, ai_score int, teacher_score int, answers_json text, report_text text, ai_review text, teacher_comment text, review_status varchar(20) not null default 'SUBMITTED', current_version_no int not null default 0,
...
create table if not exists submission_version (
  id bigint not null auto_increment primary key, submission_id bigint not null, version_no int not null, report_text text, attachment_json text, ai_score int, ai_review text, created_at datetime not null,
...
create table if not exists course_enrollment (
  id bigint not null auto_increment primary key, course_id bigint not null, student_id bigint not null, active boolean not null default true, joined_at datetime not null,
...
create table if not exists course_invite_code (
  id bigint not null auto_increment primary key, course_id bigint not null, invite_code varchar(20) not null unique, enabled boolean not null default true, expires_at datetime null, created_at datetime not null,
  constraint fk_mysql_invite_course foreign key (course_id) references course(id) on delete cascade
);
create table if not exists user_notification (
  id bigint not null auto_increment primary key, user_id bigint not null, notification_type varchar(30) not null, title varchar(220) not null, content varchar(1000) not null, source_type varchar(40), source_id bigint, is_read boolean not null default false, created_at datetime not null,
...
create table if not exists rubric_template (
  id bigint not null auto_increment primary key, teacher_id bigint not null, name varchar(160) not null, dimensions_json text not null, enabled boolean not null default true, version_no int not null default 1, created_at datetime not null, updated_at datetime not null,
...
create table if not exists teaching_alert (
  id bigint not null auto_increment primary key, teacher_id bigint not null, title varchar(240) not null, summary varchar(500) not null, target_name varchar(160) not null, level varchar(20) not null, status varchar(20) not null, analysis text not null, evidence text, proposal text, created_at datetime not null,
...
create table if not exists assistant_session (
  id bigint not null auto_increment primary key, teacher_id bigint not null, title varchar(200) not null, created_at datetime not null, updated_at datetime not null,
...
create table if not exists assistant_message (
  id bigint not null auto_increment primary key, session_id bigint not null, role varchar(20) not null, content text not null, created_at datetime not null,
...
create table if not exists conversation (
  id bigint not null auto_increment primary key, teacher_id bigint not null, student_id bigint, contact_name varchar(120) not null, contact_type varchar(20) not null, avatar_text varchar(10), unread_count int not null default 0, student_unread_count int not null default 0, updated_at datetime not null,
...
create table if not exists conversation_message (
  id bigint not null auto_increment primary key, conversation_id bigint not null, sender varchar(20) not null, title varchar(220), content text not null, created_at datetime not null,
...
create table if not exists student_assistant_session (
  id bigint not null auto_increment primary key, student_id bigint not null, title varchar(200) not null, created_at datetime not null, updated_at datetime not null,
  constraint fk_mysql_student_assistant_session_student foreign key (student_id) references user_account(id) on delete cascade
);
create table if not exists student_assistant_message (
  id bigint not null auto_increment primary key, session_id bigint not null, role varchar(20) not null, content text not null, created_at datetime not null,
  constraint fk_mysql_student_assistant_message_session foreign key (session_id) references student_assistant_session(id) on delete cascade
);
